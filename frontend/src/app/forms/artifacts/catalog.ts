...
export const TEMPLATE_LIBRARY: TemplateDescriptor[] = [
  ...
  },
  {
    ...
    usageNotes: [
      ...
      "Carries a blank `Municipio` field rather than a pre-printed municipality — the same OCAM layout family as PA03/PA04, which is exactly why it cannot stand in as any one municipality's official form.",
      "Reference layout for the canonical municipal field model (45 native AcroForm fields).",
    ],
  },
  {
    formCode: "PA03",
